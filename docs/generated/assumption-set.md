...
# Analysis assumption set (v1.28.0)
...
### Elixir default-argument wrappers retain their declared body
...
### Elixir structural protocol v2 has closed, bounded runtime consumers
